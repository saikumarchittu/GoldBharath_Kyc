...
public class BaseClass_GoldBharath {
	...
	public static WebDriver sDriver;
		...
		{  
			...
			String URL = pUtility.readDataFromPropertyFile("goldbharath");
...
//		    driver.findElement(By.xpath("//p[.='Account']")).click();
	...
	@AfterMethod(groups={"sprint-1","Sprint-2"})
		...
		{
		    Thread.sleep(2000);
	        driver.findElement(By.xpath("//img[@data-bs-target='#exampleModalLogout']")).click();
		    Thread.sleep(3000);
		    driver.findElement(By.xpath("//p[.='Log Out']")).click();
		    Thread.sleep(3000);
